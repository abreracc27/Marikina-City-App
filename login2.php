		...
		<form method="POST" style="height: 100%;">
			<div class="row py-4" style="height: 100%;">
				...
				<div class="col-12 col-lg-12 mt-4" style="text-align: center; position: relative; height: calc(100vh - 505px);">
					<input type="password" id="password" class="display-otp" maxlength="6" name="password"></br>
				</div>
				<div class="col-12 col-lg-12" style="text-align: center">
					...
					<input type="submit" value="Enter" id="enter" name="login-user" class="pinButton enter"/>
				</div>
			</div>
		</form>
    </div>
