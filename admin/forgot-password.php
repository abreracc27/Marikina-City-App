		...
		<form action="forgot-password" method="POST" autocomplete="">
			<div class="row">
				...
				<div class="col-12 col-lg-12">
					...
					<input class="login-credentials" id="email" type="email" name="email" placeholder="Enter Email" required value="<?php echo $email ?>">
				</div>
				<?php
				if(count($errors) > 0){
					?>
			...
			<div class="row">
				...
				<div class="col-6 col-lg-6 mt-3">
					<button class="login-button" name="check-email" type="submit">Search</button>
				</div>
			</div>
        </div>
    </div>
