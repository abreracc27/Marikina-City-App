...
<title>Change Password — Marikina City Health & Safety Application</title>
...
<body class="body-margin marikina-color">
	...
	<div class="login-form container-fluid"> 
		<form action="change-password" method="POST" autocomplete="">
			<div class="row">
				...
				<div class="col-12 col-lg-12 mt-1">
					...
					<input class="login-credentials" id="password" type="password" name="password" minlength="8" placeholder="Enter new password" required>
			...
			<div class="row">
				<div class="col-6 col-lg-6 mt-3">
					<a href="login"><button class="cancel-button" type="button">Cancel</button></a>
				</div>
				<div class="col-6 col-lg-6 mt-3">
					<button class="login-button" name="change-password" type="submit">Change Password</button>
				</div>
			</div>
        </div>
    </div>
