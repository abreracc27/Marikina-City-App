		...
		<form method="POST" style="height: 100%;">
			<div class="row py-4" style="height: 100%;">
				...
				<div class="col-12 col-lg-12" style="text-align: center">
					...
					<input type="submit" value="Enter" id="enter" name="verify-otp3" class="pinButton enter"/>
				</div>
				<div class="col-12 col-lg-12">
					<span class="create-account">Didn't receive the verification OTP? <a style="text-decoration: none;" id="cd" href="controller?resend2=1">Resend<span id="timer"><span id="time"></span></span></a></span>
				</div>
			</div>
		</form>
    </div>
...
<script>
	...
	setTimeout(function() {
		button.href="controller?resend2=1"; 
		button.style="text-decoration: none;";      
	}, counter * 1000);

	$(document).on("click", "#cd", function(event){
		window.location.replace("controller?resend2=1");
		if($('#time').length > 0){
			if(sessionStorage.getItem("counter")){
				if(sessionStorage.getItem("counter") > 0){
					var counter = sessionStorage.getItem("counter");
