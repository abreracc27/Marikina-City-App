		...
		<form method="POST" style="height: 100%;">
			<div class="row py-4" style="height: 100%;">
				...
				<div class="col-12 col-lg-12">
					<span class="login-text">Confirm Change PIN</span>
					<p id="demo"></p>
				</div>
				...
				<div class="col-12 col-lg-12 my-4" style="text-align: center; position: relative; height: calc(100vh - 560px);">
					<input type="password" id="password" class="display-otp" name="cpassword"></br>
					<input type="hidden" id="password1" class="display-otp" name="password" value="<?php echo $password;?>">
				</div>
				<div class="col-12 col-lg-12" style="text-align: center">
					...
					<input type="submit" value="Enter" id="enter" name="change-password" class="pinButton enter"/>
				</div>
			</div>
		</form>
    </div>
