        ...
        <form method="POST" onsubmit="process(event)">
            <div class="row" style="position: absolute; left: 0; top: 30px;">
                ...
                <div class="col-12 col-lg-12">
                    <span class="login-text">Recover Account</span>
                </div>

				<div class="col-12 col-lg-12" style="text-align: center;">
                    <span style="font-size: 12px;">Recover your account</span>
                </div>
                ...
                <div class="col-12 col-lg-12"> 
					...
					<div class="input-box">
                    	...
                    	<input id="phone" type="tel" class="login-credentials" name="phone" placeholder="Phone Number" style="width: 100% !important;" />  
					</div>
				</div>
			...
			<div class="button-container">
				<div class="col-12 col-lg-12 my-4">
					<input class="login-button" type="submit" name="recover-user" value="Recover Account">
				</div>
				<div class="col-12 col-lg-12">
...
<script src="javascript/number-input.js?v=<?php echo time(); ?>"></script>
