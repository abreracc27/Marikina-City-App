		...
		<form method="POST" style="height: 100%;">
			<div class="row py-4" style="height: 100%;">
				<div class="col-12 col-lg-12 order-lg-first">
					<a href="register"><i class="fas fa-arrow-left" style="font-size: 16px !important; color: var(--button-color);"></i></a>
				</div>

				<div class="col-12 col-lg-12">
					<span class="login-text">Account PIN</span>
				</div>

				<div class="col-12 col-lg-12" style="text-align: center;">
					<span style="font-size: 12px;">Enter Your Account PIN for<br><b><?php echo $phone;?></b></span>
				</div>   
				...
				<div class="col-12 col-lg-12 mt-4" style="text-align: center; position: relative; height: calc(100vh - 505px);">
					<input type="password" id="password" class="display-otp" name="pin1"></br>
				</div>
				<div class="col-12 col-lg-12" style="text-align: center">
					...
					<input type="submit" value="Enter" id="enter" name="pin" class="pinButton enter"/>
				</div>
			</div>
		</form>
    </div>
